...
export default function Maincontent() {
    ...
    It is governed by the Ministry of Magic. In this website you will find some information about this world, specially from the most famous school
    of magic in the entirely wizarding world,`
    return (
        <>
        <div className="flex flex-col text-center text-white mx-20 my-10 font-aboreto">
            ...
            {wizardWorldText} <span className="font-bold text-amber-300">Hogwarts.</span>
            </div>
