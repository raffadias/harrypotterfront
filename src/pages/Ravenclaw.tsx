        ...
        <>
            <div className="bg-gray-700 h-screen w-auto">
                <div className="flex flex-col text-center font-aboreto">
                    <Sidebar />
                    <div 
                        className="border-2 border-solid bg-[#0E1A40] border-[#B08D57] rounded-xl h-auto w-auto 
                        ml-[15rem] mr-[10rem] sm:ml-[8rem] sm:mr-5 sm:mt-[1rem] mt-[2rem]">
                        <div className="flex flex-col justify-center">
                            <img src={logo} alt="" className="h-20 w-20 mt-5 self-center"/>
                            <h1 className="font-bold text-white self-center mt-[0.5rem] text-4xl md:text-2xl sm:text-md shadow-sm">Ravenclaw House</h1>
                        </div>
                        ...
                        <div className="flex flex-col justify-center mx-auto my-auto md:hidden">
                            <img src={rowena} className="h-[18rem] w-[10rem] lg:h-[16rem] lg:w-[8rem] self-center mt-5 rounded-xl border-2 border-[#B08D57] shadow-lg" alt="" />
