        ...
        <>
            <div className="bg-gray-700 h-screen w-auto">
                <div className="flex flex-col text-center font-aboreto">
                    <Sidebar />
                    <div className="border-2 border-solid bg-[#b48c1d] border-gray-900 rounded-xl h-[45rem] ml-[15rem] mr-[10rem] mt-[2rem]">
                        <div className="flex flex-col justify-center">
                            <img src={logo} alt="" className="h-20 w-20 mt-5 self-center"/>
                            <h1 className="font-bold text-white self-center mt-[1rem] text-4xl shadow-sm">Hufflepuff House</h1>
                        </div>
                        <div className="text-xl text-white mt-[2rem] mx-[2rem]">
                            {mainText}
                        </div>
                        <div className="flex flex-col justify-center">
                            <img src={helga} className="h-[18rem] w-[10rem] self-center mt-5 rounded-xl border-2 border-gray-900 shadow-lg" alt="" />
